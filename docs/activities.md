...
| Google sign-in, self-serve personal/public tenancy | onboarding is admin-minted enrollment tokens per agent for now (decision 10) | external users need self-serve; handoff already written in statefs/docs/handoffs |
