...
**Status: draft, not built.** Verified against OpenAI's current Codex CLI
docs (developers.openai.com/codex/hooks, fetched 2026-09-17), not the
channel's earlier "from memory, must be checked" notes — those understated
what Codex CLI can do today.
