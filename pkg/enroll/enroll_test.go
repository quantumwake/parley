...
func TestParseURL(t *testing.T) {
	cases := []struct {
		...
		{"https://example.test/enroll?token=en_abc", "https://example.test", "en_abc", false},
		{"https://example.test/enroll#en_abc", "https://example.test", "en_abc", false},
		{"statefs://enroll?directory=https://d.example&token=en_x", "https://d.example", "en_x", false},
		{"en_bare", "", "en_bare", false},
		{"https://example.test/other?token=en_abc", "", "", true},
