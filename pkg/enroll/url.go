// Package enroll turns an enrollment URL minted by a statefs.ai
// organization into a local identity: a keypair is generated on this machine, the
...
type Request struct {
	Directory string // directory base URL from the enrollment link
...
//
//	https://<directory>/enroll?token=en_...[&tenant=...]
//	https://<directory>/enroll#en_...
//	https://<directory>/enroll#en_...&statefs_ai=https://app.statefs.ai
//	statefs://enroll?directory=https://<directory>&token=en_...
